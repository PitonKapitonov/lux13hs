...
/*    logic [79:0] rx_configuration_vector;
    assign rx_configuration_vector[79:32] = { 8'h00, 8'h0a, 8'h35, 8'h00, 8'h01, 8'h02 }; // Receiver Pause doble_row_bot Source Address[47:0]
    assign rx_configuration_vector[31:16] = 1600; // Receiver Max doble_row_bot Size[15:0].
    assign rx_configuration_vector[15] = 0; // Reserved
    assign rx_configuration_vector[14] = 0; // Receiver Max doble_row_bot Enable
    ...
    assign rx_configuration_vector[9] = 0; // Receiver Control doble_row_bot Length Check Disable
    ...
    assign rx_configuration_vector[4] = 0; // Receiver Jumbo doble_row_bot Enable
    ...
    assign tx_configuration_vector[79:32] = { 8'h00, 8'h0a, 8'h35, 8'h00, 8'h01, 8'h02 }; // Transmitter Pause doble_row_bot Source Address[47:0]
    assign tx_configuration_vector[31:16] = 4500; // Transmitter Max doble_row_bot Size[15:0].
    assign tx_configuration_vector[15] = 0; // Reserved
    assign tx_configuration_vector[14] = 0; // Transmitter Max doble_row_bot Enable
    ...
    assign tx_configuration_vector[8] = 0; // Transmitter Interdoble_row_bot Gap Adjust Enable.
    ...
    assign tx_configuration_vector[4] = 1; // Transmitter Jumbo doble_row_bot Enable
